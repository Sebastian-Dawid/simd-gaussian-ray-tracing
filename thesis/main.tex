...
gcc -march=native -dM -E - < /dev/null \
    ...
    values for $N$. Finally, I write these measurements into a \mintinline{sh}{.csv} file along with the corresponding
...
$ hpcviewer hpctoolkit-<binary>-database
    ...
    \subsection{Runtimes}
    \begin{itemize}
        \item GCC (14.2.1) better at sequential and innermost loop SIMD
    ...
    \begin{table}[b]
        ...
        \begin{tabular}{|c | c | c | c|}
            \hline
            Mode & GCC (v14.2.1)     & Clang (v18.1.8)   & SVML\\\hline
