...
simd_render_image<vcl_exp, simd_abramowitz_stegun_erf>
    ...
    frequency of $3.0$GHz. I locked the frequency using the userspace frequency scaling governor and \mintinline{sh}{cpupower}
...
gcc -march=native -dM -E - < /dev/null \
    ...
    \begin{itemize}
        \item averaged cycle count (pmu-tools) \mintinline{c}{PERF_COUNT_HW_CPU_CYCLES} (exp: Figure~\ref{fig:cycles_exp}, erf: Figure~\ref{fig:cycles_erf})
